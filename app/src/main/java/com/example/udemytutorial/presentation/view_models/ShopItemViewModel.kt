...
import com.example.udemytutorial.domain.use_cases.AddShopItemUseCase
...
class ShopItemViewModel() : ViewModel() {
    ...
    private var _screenCanBeFinished = MutableLiveData<Unit>()
    val screenCanBeFinished: LiveData<Unit>
        get() = _screenCanBeFinished
    ...
    private fun finishWork() {
        _screenCanBeFinished.value = Unit
    }
}